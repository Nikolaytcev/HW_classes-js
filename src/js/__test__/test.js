...
test.each([[new Character('Mark', 'Undead'), {name: 'Mark', type: 'Undead', health: 100, level: 1}],
[new Character('Legolas', 'Bowman'), {name: 'Legolas', type: 'Bowman', health: 100, level: 1}],
[new Character('Said', 'Swordsman'), {name: 'Said', type: 'Swordsman', health: 100, level: 1}],
[new Character('Gendalf', 'Magician'), {name: 'Gendalf', type: 'Magician', health: 100, level: 1}],
[new Character('Leviafan', 'Daemon'), {name: 'Leviafan', type: 'Daemon', health: 100, level: 1}],
[new Character('Shaun', 'Zombie'), {name: 'Shaun', type: 'Zombie', health: 100, level: 1}],
...
test("chek levelUp method", () => {
    expect(new Undead('ssdf', 'Undead').levelUp()).toEqual({name: 'ssdf', type: 'Undead', health: 100, level: 2, attack: 48, defence: 12})
})

test("chek damage function", () => {
    const character = new Zombie('dead', "Zombie");
    character.damage(1000);
    expect(character.health).toEqual(-500)
})

test("chek levelUp method with throw error", () => {
    const swordsman = new Swordsman("Gimli", "Swordsman");
